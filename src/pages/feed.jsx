    ...
    return <div className="feed__page h-full bg-[#f1f1f1] relative">
        ...
        <div className="feed flex h-full ">
            ...
            <div className="posts 2xl:min-w-[52.5rem] lg:w-[42rem] h-[calc(100vh-6.75rem)] sm:h-[calc(100vh-3.75rem)]  bg-[#f1f1f1] flex-grow overflow-y-auto   flex flex-col items-center justify-start ">
                <div className="filter__buttons mt-4 py-[1.25rem] w-full flex items-center justify-center gap-[2.5rem]">
                    <button onClick={() => setSortingMethod("Trending")} className="2xl:w-[18.75rem] lg:w-[12.75rem] w-[8rem]  transition-all h-[3.125rem] shadow-[0px_20px_10px_-10px_#FFB8B8B3] hover:text-slate-500 hover:bg-[#FFB8B8CC] text-white font-bold bg-[#FFB8B8] ">Trending</button>
                    <button onClick={() => setSortingMethod("Latest")} className="2xl:w-[18.75rem] lg:w-[12.75rem] w-[8rem] transition-all h-[3.125rem] shadow-[0px_10px_20px_-10px_#6b63ff] hover:bg-[rgba(0,0,0,0.15)] hover:text-white bg-white font-bold">Latest</button>
                </div>
                <div className="sorting__details mt-4 gap-2  flex flex-col ">
                ...
                <ul className="postsContainer mt-3 px-2 sm:px-0 relative container flex flex-col gap-[20px] items-center justify-start mb-4  ">
