...
export const Feed = () => {
    ...
    return <div className="feed__page h-full bg-[#f1f1f1]">
        <header className="top__header shadow h-[3.75rem] w-full px-[20px] py-[12px] bg-[#FFB8B82E]"><h1 className="text-[24px] drop-shadow-md
        ">Community<span className="text-[#6C63FF]">Net</span></h1></header>
        <div className="feed flex h-full my-4">
            <div className="left__nav bg-[#f1f1f1] h-full  w-[18.75rem] px-[42px]">
                <div className="container w-[13.1875rem] h-[15rem] rounded-[10px] bg-white text-[#6C63FF] flex flex-col items-start justify-center px-[60px] gap-[20px]">
                    <Link className="text-left text-[1rem] font-bold drop-shadow-sm" to="/">Home</Link>
                    <Link className="text-left text-[1rem] font-bold drop-shadow-sm" to="/">Explore</Link>
                    <Link className="text-left text-[1rem] font-bold drop-shadow-sm" to="/">Bookmarks</Link>
                    <Link className="text-left text-[1rem] font-bold drop-shadow-sm" to="/">Profile</Link>
                </div>
            </div>
            <div className="posts min-w-[52.5rem] h-[calc(100vh-5.75rem)]  bg-[#f1f1f1] flex-grow overflow-y-auto flex flex-col items-center justify-start ">
                ...
                <ul className="postsContainer mt-[4rem] container flex flex-col gap-[50px]">
                    {allPosts.map((post) => {
