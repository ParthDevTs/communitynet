                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className={`loginForm ${loginFormMode ? `mt-[2.75rem]` : `mt-[1rem]`} flex flex-col gap-[0.81rem] w-full`}>
                        ...
                        <div className="formControl flex flex-col justify-center items-start gap-[0.4rem] w-full ">
                            ...
                            <input placeholder="******" autoComplete="current-password" onChange={formik.handleChange} value={formik.values.password} onBlur={formik.handleBlur} type={`${!showPass ? "password" : "text"}`} name="password" id="password" className="w-full caret-pink-500 h-[2.1875rem] disabled:bg-#0000003d border-black border-2 text-[#A0616A] text-[0.75rem] font-[700] px-[0.69rem] py-[0.63rem]" />
                            {loginFormMode && <p onClick={() => setShowPass(!showPass)} className="passShow">
                                {showPass ?
