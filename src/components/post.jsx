...
export const Post = ({ post }) => {
    ...
    return <div
        className="post shadow-[0px_4px_8px_-4px_rgba(0,0,0,0.25)] relative rounded-md bg-white py-2 px-3 sm:px-[1.56rem] flex flex-col justiy-center gap-[1rem] w-full sm:w-[20rem] lg:w-[30rem] xl:w-[40rem] 2xl:w-[50rem]">
        <header
        ...
        <div className="postContent flex flex-col gap-4 w-full">
            ...
            {post.image &&
                <div onClick={() => navigate(`/post/${_id}`)} className="image__container flex-grow w-full grid place-content-center cursor-pointer" >
                    <img loading="lazy" className="2xl:max-w-[740px] aspect-auto sm:aspect-square lg:aspect-video 2xl:max-h-[540px] object-cover  object-center  rounded-md" src={post.image} alt={username} />
                </div>}
        </div>
