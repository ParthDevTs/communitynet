    ...
    return <div
        ...
        <div className="action__buttons flex items-center justify-evenly w-[47remrem] h-[1.875rem]">
            <button onClick={() => { userExistsLiked ? disLikedPost(_id) : likeaPost(_id) }}
                className={`like__button drop-shadow-md hover:drop-shadow-xl hover:text-[#fe7575] transition-colors ${userExistsLiked ? "text-red-600" : null}`}>
            ...
            <button
                className="comment__button drop-shadow-md hover:drop-shadow-xl hover:text-[#fe7575]">
            ...
            <button className="send__button drop-shadow-md hover:drop-shadow-xl hover:text-[#fe7575]">
                <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
